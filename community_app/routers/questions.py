...
from community_app.models.questions import Questions  # Импортируем модель Questions из модуля models
from community_app import db  # Импортируем объект базы данных db из модуля community_app
