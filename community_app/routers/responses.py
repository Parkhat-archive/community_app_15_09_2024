...
from community_app.models.questions import Questions, Statistics  # Импортируем модели Questions и Statistics
from community_app.models.responses import Responses  # Импортируем модель Responses

from community_app import db  # Импортируем экземпляр базы данных
