...
from community_app.routers.questions import questions_bp  # Импортируем Blueprint для вопросов.
from community_app.routers.responses import response_bp  # Импортируем Blueprint для ответов.
